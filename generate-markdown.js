...
try {
    ...
    const proxies = rawContent.split(/\r?\n/)
    ...
    if (proxies.length > 0) {
        // --- 1. Updated Table Header Order ---
        markdownContent += `| IP Address | Location | ISP / Organization |\n`;
        markdownContent += `|------------|----------|--------------------|\n`;
        ...
        proxies.forEach(proxy => {
            ...
            // --- Updated Column Order in Row ---
            markdownContent += `| \`${ip}\` | ${location} | ${isp} |\n`;
        });
        
        // --- 2. Removed the Copy-Paste Section ---
